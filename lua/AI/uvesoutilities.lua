...
function ExtractorPause(self, aiBrain, MassExtractorUnitList, ratio, techLevel)
    ...
    if (aiBrain:GetEconomyStoredRatio('ENERGY') < 1.0 and aiBrain:GetEconomyTrend('ENERGY') < 0) or (aiBrain:GetEconomyStoredRatio('MASS') > aiBrain:GetEconomyStoredRatio('ENERGY')) then
