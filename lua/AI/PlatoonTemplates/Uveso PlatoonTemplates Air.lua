...
PlatoonTemplate {
    ...
    Plan = 'InterceptorAIUveso',
    GlobalSquads = {
        { categories.MOBILE * categories.AIR * categories.ANTIAIR * categories.HIGHALTAIR - categories.EXPERIMENTAL, 1, 12, 'Attack', 'none' },
    }
}
PlatoonTemplate {
...
PlatoonTemplate {
    ...
    Plan = 'InterceptorAIUveso',
    GlobalSquads = {
        { categories.MOBILE * categories.AIR * categories.ANTIAIR * categories.HIGHALTAIR - categories.EXPERIMENTAL, 2, 500, 'Attack', 'none' },
    }
}
PlatoonTemplate {
    ...
    Plan = 'InterceptorAIUveso',
    GlobalSquads = {
        { categories.MOBILE * categories.AIR * categories.GROUNDATTACK - categories.EXPERIMENTAL - categories.ANTINAVY , 2, 500, 'Attack', 'none' }
    }
}
--EnemyZone
PlatoonTemplate {
    ...
    Plan = 'InterceptorAIUveso',
    GlobalSquads = {
        { categories.MOBILE * categories.AIR * categories.ANTIAIR - categories.EXPERIMENTAL - categories.GROUNDATTACK - categories.BOMBER, 10, 10, 'Attack', 'none' },
    }
}
...
PlatoonTemplate {
    ...
    Plan = 'InterceptorAIUveso',
    GlobalSquads = {
        { categories.MOBILE * categories.AIR * categories.GROUNDATTACK - categories.EXPERIMENTAL - categories.ANTINAVY , 3, 20, 'Attack', 'none' }
    }
}
